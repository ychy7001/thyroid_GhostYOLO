...
__all__ = ['C3k2_GhostModule_DynamicConv','C2f_GhostModule_DynamicConv','DynamicConv']
...
class C3k2_GhostModule_DynamicConv(C2f_GhostModule_DynamicConv):
    ...
    def __init__(self, c1, c2, n=1, c3k=False,num_tokens=49, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            C3k(self.c, self.c, 2, shortcut, g) if c3k else  GhostModule(self.c, self.c) for _ in range(n)
        )
